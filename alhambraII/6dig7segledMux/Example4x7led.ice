{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "191c1915-c2ea-402a-8e3b-542f9cfcda37",
          "type": "basic.output",
          "data": {
            "name": "an",
            "range": "[3:0]",
        ...
        {
          "id": "35ff1fb3-30de-42f2-8759-daf40a2a6384",
          "type": "89a1420f8d3689db52110df2708540663fad2a14",
          "position": {
            "x": 376,
            "y": 152
          },
      ...
      "wires": [
        {
          "source": {
            "block": "35ff1fb3-30de-42f2-8759-daf40a2a6384",
        ...
        },
        {
          "source": {
            "block": "35ff1fb3-30de-42f2-8759-daf40a2a6384",
            "port": "894ebbc5-ca1b-460b-b261-3f8f9418d731"
          },
          "target": {
            "block": "191c1915-c2ea-402a-8e3b-542f9cfcda37",
            "port": "in"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    ...
    "89a1420f8d3689db52110df2708540663fad2a14": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "894ebbc5-ca1b-460b-b261-3f8f9418d731",
              "type": "basic.output",
              "data": {
                "name": "an",
                "range": "[3:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "894ebbc5-ca1b-460b-b261-3f8f9418d731",
                "port": "in"
              },
              "size": 4
            }
