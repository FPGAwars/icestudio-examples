  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "0f2ebaf5-3fd5-4e18-9752-d40c3c9743dc",
          "type": "basic.constant",
          "data": {
            "name": "Module",
            "value": "10",
        ...
        {
          "id": "b22953b4-7cb2-48e0-bbcc-b360753631d8",
          "type": "basic.constant",
          "data": {
            "name": "24H",
            "value": "24",
        ...
        {
          "id": "9e45b0d4-4ddb-450f-894e-960fdccfbf64",
          "type": "basic.constant",
          "data": {
            "name": "60 Sec/Min, Min/Hour",
            "value": "6",
            "local": false
          },
          "position": {
        ...
        {
          "id": "a2ccc822-72fa-4d7a-9ada-52c239f55c92",
        ...
        {
          "id": "40a152cd-afd4-49ed-84a5-b9c118059592",
          "type": "basic.info",
          "data": {
            "info": "<h2>HH:MM:SS Counter with SW1 start</h2>\n<ul>\n<li>6 x 7led display digits block\n<li>Module 6 for decimal minutes and hours\n<li>Module 24 for decimal hours\n<li>Beat in seconds, adaptable to msec or usec\n<li>Common anode 7led mode, change 0<->1 in Verilog table code for catode mode\n</ul>\n<p>Configure 7led outputs to a,b,c,d,e,f,g segments, and an[5:0] to \neach digit enable signal (common anode in this example).\n<p>2019 FPGAwars @agnuca \n",
            "readonly": true
          },
          "position": {
            "x": 696,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "0f2ebaf5-3fd5-4e18-9752-d40c3c9743dc",
            "port": "constant-out"
          },
          "target": {
            "block": "1c6a0982-15f7-492a-bd88-49d0cf95b811",
        ...
        {
          "source": {
            "block": "9e45b0d4-4ddb-450f-894e-960fdccfbf64",
            "port": "constant-out"
          },
          "target": {
            "block": "b78fdfa4-3e3b-42b3-9b50-882189df66d9",
        ...
        {
          "source": {
            "block": "a2ccc822-72fa-4d7a-9ada-52c239f55c92",
        ...
        {
          "source": {
            "block": "b22953b4-7cb2-48e0-bbcc-b360753631d8",
            "port": "constant-out"
          },
          "target": {
            "block": "3dcce29d-f474-4677-b185-a6b2c065ca83",
