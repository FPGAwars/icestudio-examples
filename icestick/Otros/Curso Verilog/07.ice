{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "eba878db-d058-4ded-90a7-793ffbc98c3a",
          "type": "basic.code",
          "data": {
            "code": "//Asynchronous or latched logic.\n//the sensitivity list must contain all expressions that are used within the always block\n\nreg y1;\n\n//Asinchronous. A event/change in  a,b or operation generate a  change at the outpuy y1\nalways @* //  * means all expressions within the always block\nbegin\n    if(operation)\n        y1 <=a | b;\n    else\n        y1<= 0;\nend\n\n//latch.  If don't ways are completed ----> generate a latch.\n//this option is not good and syntesis tool could generate a error \n/*\nalways @* //  * means all expressions within the always block\nbegin\n    if(operation)\n        y2 <=a | b;\n   \nend\n*/\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "7569e2fa-9355-48e6-a060-65f967227d79",
        ...
        {
          "id": "64863e83-dd70-47e3-80e1-e1ab80518539",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "fe979ec4-c9f6-4a82-8187-8a92fcc182da",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "2a2e588a-233c-4576-a020-14ce1eacc146",
      ...
      "wires": [
        {
          "source": {
            "block": "eba878db-d058-4ded-90a7-793ffbc98c3a",
            "port": "y1"
          },
          "target": {
            "block": "64863e83-dd70-47e3-80e1-e1ab80518539",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "fe979ec4-c9f6-4a82-8187-8a92fcc182da",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "7569e2fa-9355-48e6-a060-65f967227d79",
        ...
        {
          "source": {
            "block": "2a2e588a-233c-4576-a020-14ce1eacc146",
