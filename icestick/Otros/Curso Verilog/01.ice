{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ce6f87a0-7fb4-41d6-acda-93d09d1293aa",
          "type": "basic.info",
          "data": {
            "info": "\nCombinational circuit. Is a gate AND\nAt this circuit we are using one continuos assignement."
          },
          "position": {
            "x": 488,
            "y": 32
        ...
        {
          "id": "e383fa77-4b64-4e21-8ba1-9636e82cc3e2",
        ...
        {
          "id": "4e99c149-2fe4-43f7-9d25-e444ae00481b",
          "type": "basic.code",
          "data": {
            "code": "\n// AND gate\nassign c = a & b;",
            "params": [],
        ...
        {
          "id": "cee95494-c33c-4f4c-9c45-df91b71009ee",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "75a2ec82-2488-4e41-b5e5-6641b1c88f84",
        ...
        {
          "id": "d4db0506-8386-40bc-8374-e3ea8d4e4a78",
          "type": "basic.info",
          "data": {
            "info": "\nCombinational circuit using \"always\".\nIt is necessary to define output as a \"reg type\"."
          },
          "position": {
            "x": 488,
            "y": 280
        ...
        {
          "id": "68a29820-d0a6-4c5b-8478-49cd866c5f49",
          "type": "basic.code",
          "data": {
            "code": "\nreg f; // type reg  (type wire is not possible)\n\nalways @ (d or e)\nbegin\n    f = d & e;\nend\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "fabcfca0-c317-4978-9608-8781c527f813",
          "type": "basic.output",
          "data": {
            "name": "out1",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "e383fa77-4b64-4e21-8ba1-9636e82cc3e2",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "4e99c149-2fe4-43f7-9d25-e444ae00481b",
            "port": "a"
          }
        },
        {
          "source": {
            "block": "75a2ec82-2488-4e41-b5e5-6641b1c88f84",
        ...
        },
        {
          ...
          "target": {
            "block": "cee95494-c33c-4f4c-9c45-df91b71009ee",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "68a29820-d0a6-4c5b-8478-49cd866c5f49",
            "port": "d"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "fabcfca0-c317-4978-9608-8781c527f813",
            "port": "in"
          }
        }
      ]
