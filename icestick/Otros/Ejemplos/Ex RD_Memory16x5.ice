{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9fec5b08-323c-413b-b146-ee6b411c5c8b",
          "type": "basic.output",
          "data": {
            "name": "out4",
            "pins": [
        ...
        {
          "id": "a8c9466d-8882-4273-ba18-0a9b6d2167e8",
          "type": "basic.output",
          "data": {
            "name": "out3",
            "pins": [
        ...
        {
          "id": "bce9c572-34c1-45c7-9b3d-a9a236aa8d7d",
        ...
        {
          "id": "f6de8247-4c25-415b-89ee-03393d174099",
          "type": "e4a658970ebe18b8a4e260debd21b103cee305f8",
          "position": {
            "x": 592,
            "y": 184
          },
        ...
        {
          "id": "b40a2801-12be-4918-995c-ab3d673a526b",
          "type": "basic.output",
          "data": {
            "name": "out2",
            "pins": [
        ...
        {
          "id": "37d7917f-ecd2-4643-92ef-31583cd13786",
        ...
        {
          "id": "5705e4ca-39ac-42f0-bebb-6d814d93a01b",
        ...
        {
          "id": "fd229b10-31f5-4c41-ba50-619da568aca7",
          "type": "basic.output",
          "data": {
            "name": "out1",
            "pins": [
        ...
        {
          "id": "34a392c0-4005-4b31-95ab-40f81d58953f",
          "type": "basic.output",
          "data": {
            "name": "out0",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "5705e4ca-39ac-42f0-bebb-6d814d93a01b",
            "port": "7e07d449-6475-4839-b43e-8aead8be2aac"
          },
          "target": {
            "block": "37d7917f-ecd2-4643-92ef-31583cd13786",
        ...
        },
        {
          ...
          "target": {
            "block": "f6de8247-4c25-415b-89ee-03393d174099",
        ...
        },
        {
          "source": {
            "block": "f6de8247-4c25-415b-89ee-03393d174099",
            "port": "c6d24983-5d73-4043-b3cc-d7001b3dea21"
          },
          "target": {
            "block": "9fec5b08-323c-413b-b146-ee6b411c5c8b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "a8c9466d-8882-4273-ba18-0a9b6d2167e8",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "b40a2801-12be-4918-995c-ab3d673a526b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "fd229b10-31f5-4c41-ba50-619da568aca7",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "34a392c0-4005-4b31-95ab-40f81d58953f",
            "port": "in"
          },
          "vertices": [
            {
