{
  ...
  "state": {
    "pan": {
      "x": -81.92271195425575,
      "y": 166.87308051625072
    },
    "zoom": 0.6437312364578247
  },
  "board": "icestick",
  "graph": {
    "blocks": [
      ...
      {
        "id": "fe216e71-da14-46a3-b058-8c76b54a1245",
        "type": "FFDcpn",
        "data": {},
        "position": {
          "x": 1008,
      ...
      {
        "id": "973a7bf0-73b4-4ab5-bac1-8a552005a388",
        "type": "logic.gate.and",
        "data": {},
        "position": {
          "x": 1016,
      ...
      {
        "id": "32d29529-2686-430b-91c6-7036ceacd3b6",
        "type": "basic.output",
        "data": {
          "label": "test Din",
          "pin": {
      ...
      {
        "id": "4551fad8-8192-4b0e-93df-9592377ad79a",
        "type": "basic.output",
        "data": {
          "label": "Test CLK",
          "pin": {
      ...
      {
        "id": "c1645b46-01ad-4476-8277-46f33069c230",
        "type": "logic.gate.and",
        "data": {},
        "position": {
          "x": 832,
      ...
      {
        "id": "dbc84e83-2006-47d9-9188-b6fdf3a4343d",
        "type": "bit.1",
        "data": {},
        "position": {
          "x": 448,
      ...
      {
        "id": "997c2cbb-f0d4-4358-af4b-a90e2dc0c808",
        "type": "DFFcp",
        "data": {},
        "position": {
          "x": 648,
      ...
      {
        "id": "563f72ed-f2c1-453b-a56e-70a682999fe5",
        "type": "basic.info",
        "data": {
    ...
    "wires": [
      {
        ...
        "target": {
          "block": "fe216e71-da14-46a3-b058-8c76b54a1245",
      ...
      },
      {
        ...
        "target": {
          "block": "973a7bf0-73b4-4ab5-bac1-8a552005a388",
      ...
      },
      {
        ...
        "target": {
          "block": "4551fad8-8192-4b0e-93df-9592377ad79a",
          "port": "in"
        }
      },
      {
        ...
        "target": {
          "block": "c1645b46-01ad-4476-8277-46f33069c230",
          "port": "97b51945-d716-4b6c-9db9-970d08541249"
        },
        "vertices": []
      },
      {
        "source": {
          "block": "dbc84e83-2006-47d9-9188-b6fdf3a4343d",
          "port": "19c8f68d-5022-487f-9ab0-f0a3cd58bead"
        },
        "target": {
          "block": "997c2cbb-f0d4-4358-af4b-a90e2dc0c808",
          "port": "99a36416-5c21-4c78-998d-8324cd9a515d"
        }
      },
      {
      ...
      },
      {
        ...
        "target": {
          "block": "32d29529-2686-430b-91c6-7036ceacd3b6",
          "port": "in"
        },
        "vertices": [
          {
